...
static const _WheelGroundHeights_type_support_symbol_names_t _WheelGroundHeights_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mpc_car_control, msg, WheelGroundHeights)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mpc_car_control, msg, WheelGroundHeights)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mpc_car_control, msg, WheelGroundHeights)() {
  return &::mpc_car_control::msg::rosidl_typesupport_c::WheelGroundHeights_message_type_support_handle;
}
