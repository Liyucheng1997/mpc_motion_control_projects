...
static char mpc_car_control__msg__ActuatorCommand__TYPE_NAME[] = "mpc_car_control/msg/ActuatorCommand";
static char builtin_interfaces__msg__Time__TYPE_NAME[] = "builtin_interfaces/msg/Time";
static char std_msgs__msg__Header__TYPE_NAME[] = "std_msgs/msg/Header";

// Define type names, field names, and default values
static char mpc_car_control__msg__ActuatorCommand__FIELD_NAME__header[] = "header";
static char mpc_car_control__msg__ActuatorCommand__FIELD_NAME__steering_angle[] = "steering_angle";
...
static rosidl_runtime_c__type_description__Field mpc_car_control__msg__ActuatorCommand__FIELDS[] = {
  {
    {mpc_car_control__msg__ActuatorCommand__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {mpc_car_control__msg__ActuatorCommand__FIELD_NAME__steering_angle, 14, 14},
    {
  ...
  {
    {mpc_car_control__msg__ActuatorCommand__FIELD_NAME__throttle, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {mpc_car_control__msg__ActuatorCommand__FIELD_NAME__brake, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {mpc_car_control__msg__ActuatorCommand__FIELD_NAME__active_suspension_force, 23, 23},
    {
...
mpc_car_control__msg__ActuatorCommand__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mpc_car_control__msg__ActuatorCommand__get_individual_type_description_source(NULL),
