...
#include "mpc_car_control/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_c.h"
...
static uint32_t _VehicleState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mpc_car_control__msg__VehicleState(
...
{
  return max_serialized_size_mpc_car_control__msg__VehicleState(
    full_bounded, 0);
}
