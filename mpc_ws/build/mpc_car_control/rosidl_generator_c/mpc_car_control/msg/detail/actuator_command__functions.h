...
#ifndef MPC_CAR_CONTROL__MSG__DETAIL__ACTUATOR_COMMAND__FUNCTIONS_H_
#define MPC_CAR_CONTROL__MSG__DETAIL__ACTUATOR_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * mpc_car_control__msg__ActuatorCommand__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mpc_car_control
mpc_car_control__msg__ActuatorCommand *
mpc_car_control__msg__ActuatorCommand__create(void);

/// Destroy msg/ActuatorCommand message.
/**
 * It calls
 * mpc_car_control__msg__ActuatorCommand__fini()
 ...
 * mpc_car_control__msg__ActuatorCommand__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mpc_car_control__msg__ActuatorCommand__Sequence__fini()
 * on the array,
...
#endif  // MPC_CAR_CONTROL__MSG__DETAIL__ACTUATOR_COMMAND__FUNCTIONS_H_
