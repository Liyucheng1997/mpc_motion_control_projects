...
void WheelGroundHeights_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) mpc_car_control::msg::WheelGroundHeights(_init);
}

void WheelGroundHeights_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mpc_car_control::msg::WheelGroundHeights *>(message_memory);
  typed_message->~WheelGroundHeights();
}

size_t size_function__WheelGroundHeights__wheel_ground_heights(const void * untyped_member)
{
  (void)untyped_member;
  return 4;
}

const void * get_const_function__WheelGroundHeights__wheel_ground_heights(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__WheelGroundHeights__wheel_ground_heights(void * untyped_member, size_t index)
{
  auto & member =
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WheelGroundHeights_message_member_array[2] = {
  {
    ...
    offsetof(mpc_car_control::msg::WheelGroundHeights, header),  // bytes offset in struct
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(mpc_car_control::msg::WheelGroundHeights, wheel_ground_heights),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WheelGroundHeights_message_members = {
...
{
  return &::mpc_car_control::msg::rosidl_typesupport_introspection_cpp::WheelGroundHeights_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mpc_car_control, msg, WheelGroundHeights)() {
  return &::mpc_car_control::msg::rosidl_typesupport_introspection_cpp::WheelGroundHeights_message_type_support_handle;
}
