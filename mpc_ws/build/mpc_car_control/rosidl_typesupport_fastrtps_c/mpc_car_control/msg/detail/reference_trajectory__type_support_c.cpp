  ...
  mpc_car_control__msg__ReferenceTrajectory * ros_message)
{
  ...
  // Field name: velocity_profile
  {
    ...
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->velocity_profile, size)) {
      fprintf(stderr, "failed to create array for field 'velocity_profile'");
      return false;
    }
    auto array_ptr = ros_message->velocity_profile.data;
  ...
  // Field name: yaw_profile
  {
    ...
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->yaw_profile, size)) {
      fprintf(stderr, "failed to create array for field 'yaw_profile'");
      return false;
    }
    auto array_ptr = ros_message->yaw_profile.data;
    cdr.deserialize_array(array_ptr, size);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mpc_car_control__msg__ReferenceTrajectory;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mpc_car_control__msg__ReferenceTrajectory * ros_message = static_cast<const mpc_car_control__msg__ReferenceTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mpc_car_control__msg__ReferenceTrajectory(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mpc_car_control__msg__ReferenceTrajectory * ros_message = static_cast<mpc_car_control__msg__ReferenceTrajectory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mpc_car_control__msg__ReferenceTrajectory(cdr, ros_message);
}
...
static size_t _ReferenceTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mpc_car_control__msg__ReferenceTrajectory(
