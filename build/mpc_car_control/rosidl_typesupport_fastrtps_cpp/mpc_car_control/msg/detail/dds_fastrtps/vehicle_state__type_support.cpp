...
#include "mpc_car_control/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const mpc_car_control::msg::VehicleState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mpc_car_control::msg::VehicleState *>(
    untyped_ros_message);
...
{
  return &mpc_car_control::msg::typesupport_fastrtps_cpp::_VehicleState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mpc_car_control, msg, VehicleState)() {
  return &mpc_car_control::msg::typesupport_fastrtps_cpp::_VehicleState__handle;
}
