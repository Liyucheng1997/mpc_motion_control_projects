...
#include <stddef.h>
#include "mpc_car_control/msg/detail/control_command_body__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember ControlCommandBody__rosidl_typesupport_introspection_c__ControlCommandBody_message_member_array[7] = {
  {
    ...
    offsetof(mpc_car_control__msg__ControlCommandBody, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mpc_car_control__msg__ControlCommandBody, fx),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mpc_car_control__msg__ControlCommandBody, fy),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mpc_car_control__msg__ControlCommandBody, mz),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
