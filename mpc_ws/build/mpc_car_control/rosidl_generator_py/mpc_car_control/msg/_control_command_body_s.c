...
bool mpc_car_control__msg__control_command_body__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mpc_car_control.msg._control_command_body.ControlCommandBody", full_classname_dest, 60) == 0);
  }
  mpc_car_control__msg__ControlCommandBody * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ControlCommandBody */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mpc_car_control.msg._control_command_body");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ControlCommandBody");
