...
class Metaclass_ReferenceTrajectory(type):
    """Metaclass of message 'ReferenceTrajectory'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'mpc_car_control.msg.ReferenceTrajectory')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__reference_trajectory
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__reference_trajectory
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__reference_trajectory
            cls._TYPE_SUPPORT = module.type_support_msg__msg__reference_trajectory
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__reference_trajectory
...
class ReferenceTrajectory(metaclass=Metaclass_ReferenceTrajectory):
    """Message class 'ReferenceTrajectory'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.yaw_profile = array.array('d', kwargs.get('yaw_profile', []))
    ...
    def __eq__(self, other):
        ...
        if self.velocity_profile != other.velocity_profile:
            return False
        if self.yaw_profile != other.yaw_profile:
            return False
        return True
